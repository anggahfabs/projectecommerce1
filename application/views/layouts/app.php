...
<body>
  ...
  <header>
    <div class="headerstrip">
      <div class="container">
        <div class="row">
          <div class="span12">
            <a href="<?= base_url() ?>" class="logo pull-left"><img src="<?= base_url('/assets/theme/') ?>img/11.png" alt="tokojayaa" title="tokojayaa"></a>
            <!-- Top Nav Start -->
            <div class="pull-left">
        ...
        <div class="pull-right">
          <ul class="nav topcart pull-left">
            <li class="dropdown hover carticon ">
              <a href="#" class="dropdown-toggle"> Keranjang Belanja <span class="label label-secondary font14"><?= $this->cart->total_items() ?> Pesan</span> - Rp<?= $this->cart->format_number($this->cart->total()) ?> <b class="caret"></b></a>
  ...
  <footer id="footer">
    <section class="copyrightbottom">
      <div class="container">
        <div class="row">
          <div class="span6"> Toko Jayaa Online Store
          </div>
          <div class="span6 textright"> Copyright © All Rights Reserved <?= date('Y') ?> </div>
        </div>
      </div>
    </section>
  </footer>
